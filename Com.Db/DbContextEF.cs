...
public class DbContextEF : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Deal>(o =>
        {
            ...
            o.Property(P => P.fee_coin_buy).IsRequired().HasColumnType("bigint").HasComment("买手续费币种");
            o.Property(P => P.fee_coin_sell).IsRequired().HasColumnType("bigint").HasComment("卖手续费币种");
        ...
        modelBuilder.Entity<Running>(o =>
        {
            ...
            o.Property(P => P.uid_from).IsRequired().HasColumnType("tinyint").HasComment("来源 用户id");
            o.Property(P => P.uid_to).IsRequired().HasColumnType("tinyint").HasComment("目的 用户id");
