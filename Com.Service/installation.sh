...
#docker run -d -p 8000:8000 --restart=always  --name e_service -v /gitlab/exchange.core/Com.Service/bin/Release/net6.0/publish/:/app -w /app mcr.microsoft.com/dotnet/runtime:6.0 dotnet Com.Service.dll
echo 更新成功
